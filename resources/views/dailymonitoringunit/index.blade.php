<x-layouts.app title="Daily">
  ...
  <form method="GET">
    ...
    <label for="cari-periode" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Periode
            Awal</label>
        <input id="cariperiode" type="date" name="dari" id="dari" value="{{ now()->format('Y-m-d') }}"
            class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-700 block w p-3.5 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-500 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        <label for="cari-periode1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Periode
            Akhir</label>
        <input id="cariperiode2" type="date" name="ke" id="ke" value="{{ now()->format('Y-m-d') }}"
            class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-700 block w p-3.5 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-500 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            <br>
    ...
    <a class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700" href="{{ '/dailymonitorings/cetak_excel?project= ' . request()->get('project') . '&dari=' . request()->get('dari') . '&ke=' . request()->get('ke') }}">CETAK EXCEL</a>
    @else
    <a class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700" href="{{ '/dailymonitorings/cetak_excel?project= ' . request()->get('project') . '&dari=' . request()->get('dari') . '&ke=' . request()->get('ke') }}">CETAK EXCEL</a>
@endif
</form>
