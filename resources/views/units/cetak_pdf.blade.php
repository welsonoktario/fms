...
<body>
  ...
  <div class="barcode">
    ...
    <img class="image" src="{{ public_path() . '/img/qrunits/logoakas.jpg' }}">
    {{-- <img src="data:image/jpg;base64,{{ base64_encode(file_get_contents(public_path('/img/qrunits/logoakas.jpg'))) }}" --}}
        alt="QR Code" width="200" height="200">
