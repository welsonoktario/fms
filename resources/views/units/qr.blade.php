<x-layouts.app title="Unit Details">
  ...
  <div class="mt-4 rounded-lg p-4 shadow bg-base-100">
    ...
    <div class="flex space-x-4">
        ...
        <a href="https://www.facebook.com" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600 transition" target="_blank" rel="noopener noreferrer">Akun Sosmed Fleet NL</a>
    </div>
</div>
</x-layouts.app>
