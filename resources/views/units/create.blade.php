    ...
    <form action="{{ route('units.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div>
          ...
          <select id="type" name="type" required
            ...
            <option value="HEAVY EQUIPMENT" {{ old('type') == 'HEAVY EQUIPMENT' ? 'selected' : '' }}>HEAVY EQUIPMENT</option>
            <option value="OPERATIONAL CAR" {{ old('type') == 'OPERATIONAL CAR' ? 'selected' : '' }}>OPERATIONAL CAR</option>
          </select>
          @error('type')
